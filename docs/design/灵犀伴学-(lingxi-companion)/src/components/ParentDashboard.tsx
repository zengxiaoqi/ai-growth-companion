          ...
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 rounded-full overflow-hidden bg-secondary-container flex items-center justify-center">
              <img 
                ...
                src="https://lh3.googleusercontent.com/aida-public/AB6AXuBlLGatppX-CokggP0QNRHNCvSodc8gLJdgY6KggETyhD4kyAmypkOusYGdCNC9PwJgIbtUlPKrQxYKDasv1Dxl8DSoGeEkyxnSFjtw3DGuErf23Z5TJropXVHxS-3xZ9rsrHdq_a1WIZ9hF7S5FOlxqcSFqzVthNkXLKrVQT_JFULZRoqF6xIGcmN685jFkLiFHD4erKX5EdEySNhZZYCmQcQJclymeyH-W2QAlVKN3O-DHUEP92bMSByk84PsGIvpXdofjrXuoJk"
      ...
      <main className="max-w-7xl mx-auto px-6 mt-8 space-y-10">
        ...
        <section className="flex flex-col md:flex-row md:items-end justify-between gap-6">
          <div className="space-y-2">
            <h2 className="text-4xl font-extrabold tracking-tight">下午好，Lingxi Curator</h2>
                ...
                <BarChart data={data}>
                  ...
                  <Bar dataKey="time" radius={[8, 8, 0, 0]}>
                    {data.map((entry, index) => (
                      <Cell key={`cell-${index}`} fill={entry.time === 95 ? '#006384' : '#f8e999'} />
                    ))}
                  </Bar>
                </BarChart>
              </ResponsiveContainer>
          ...
          <div className="md:col-span-4 flex flex-col gap-6">
            <div className="flex-1 bg-on-secondary-container text-on-secondary rounded-2xl p-6 relative overflow-hidden">
              <div className="relative z-10">
                ...
                <p className="text-5xl font-black mt-2">1,240 <span className="text-lg font-medium opacity-60">积分</span></p>
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              {[
                { title: '时间限制', desc: '每日可用 2 小时', icon: Timer, color: 'bg-secondary-container/30', iconColor: 'text-on-secondary-container', active: true },
                { title: '内容过滤', desc: '严格模式已开启', icon: ShieldCheck, color: 'bg-tertiary-container/30', iconColor: 'text-on-tertiary-container', active: true },
                { title: '护眼模式', desc: '20分钟休息提醒', icon: Eye, color: 'bg-surface-container', iconColor: 'text-outline', active: false },
              ].map((item, i) => (
