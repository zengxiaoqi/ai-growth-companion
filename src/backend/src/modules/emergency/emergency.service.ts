...
export class EmergencyService {
  ...
  constructor(
    ...
    this.accessKeyId = this.configService.get(
      "ALIBABA_CLOUD_ACCESS_KEY_ID",
      "",
    );
    this.accessKeySecret = this.configService.get(
      "ALIBABA_CLOUD_ACCESS_KEY_SECRET",
      "",
    );
    this.smsSignName = this.configService.get(
      "ALIBABA_CLOUD_SMS_SIGN_NAME",
      "灵犀伴学",
    );
    this.smsTemplateCode = this.configService.get(
      "ALIBABA_CLOUD_SMS_TEMPLATE_CODE",
      "",
    );
    this.voiceTtsCode = this.configService.get(
      "ALIBABA_CLOUD_VOICE_TTS_CODE",
      "",
    );
  }
