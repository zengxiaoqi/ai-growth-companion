...
export class RecommendService {
  ...
  private async getRecommendedContent(
    ...
    const candidates = await query.orderBy('content.difficulty', 'ASC').take(30).getMany();
  ...
  private getWeakDomains(abilities: AbilityAssessment[], _domainScores: Record<string, number>) {
