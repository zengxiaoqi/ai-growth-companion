      ...
      <AnimatePresence mode="wait">
        ...
        >
          <div className="flex items-start gap-2 justify-center">
            ...
            <button
              onClick={() => current.statement && speak(`${current.statement}。请判断是对还是错。`)}
          ...
          <div className="flex gap-3 sm:gap-4 justify-center px-2">
            <motion.button
              ...
              className={cn(
                ...
                !isRevealed &&
                  selected === true &&
                  'border-primary bg-primary-container/30 ring-2 ring-primary ring-offset-2',
                isRevealed &&
                  selected &&
                  isCorrect &&
            ...
            >
              <Check className="w-8 h-8 sm:w-10 sm:h-10" />对
            </motion.button>
            <motion.button
            ...
            >
              <X className="w-8 h-8 sm:w-10 sm:h-10" />错
            </motion.button>
          </div>
