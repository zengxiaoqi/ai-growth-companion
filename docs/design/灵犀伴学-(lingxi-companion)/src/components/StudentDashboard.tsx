...
export default function StudentDashboard({ onBack }: StudentDashboardProps) {
  ...
  const curriculumData = {
    '3-4': [
      { category: '语言', color: 'bg-secondary-container', iconColor: 'text-on-secondary-container', icon: MessageCircle, topics: ['颜色', '形状', '动物', '礼貌用语'], skills: ['看', '听', '说'] },
      { category: '数学', color: 'bg-tertiary-container', iconColor: 'text-on-tertiary-container', icon: Calculator, topics: ['数数', '比大小', '分类'], skills: ['看', '练', '说'] },
      { category: '科学', color: 'bg-primary-container', iconColor: 'text-on-primary-container', icon: Microscope, topics: ['身体', '宠物', '自然', '水'], skills: ['看', '听', '练'] },
      { category: '艺术', color: 'bg-surface-container-highest', iconColor: 'text-outline', icon: Palette, topics: ['手指画', '节奏', '儿歌'], skills: ['看', '听', '练'] },
      { category: '社会', color: 'bg-[#ffefec]', iconColor: 'text-error', icon: Users, topics: ['情绪', '分享', '排队'], skills: ['看', '听', '说', '练'] },
    ],
    '5-6': [
      { category: '语言', color: 'bg-secondary-container', iconColor: 'text-on-secondary-container', icon: BookOpen, topics: ['汉字', '绘本', '看图说话', '古诗'], skills: ['听', '说', '读', '写'] },
      { category: '数学', color: 'bg-tertiary-container', iconColor: 'text-on-tertiary-container', icon: Calculator, topics: ['减法', '时间', '找规律'], skills: ['看', '练', '写'] },
      { category: '科学', color: 'bg-primary-container', iconColor: 'text-on-primary-container', icon: Microscope, topics: ['动物分类', '植物生长', '四季', '小实验'], skills: ['看', '听', '说', '练'] },
      { category: '艺术', color: 'bg-surface-container-highest', iconColor: 'text-outline', icon: Palette, topics: ['绘画', '音乐欣赏', '手工'], skills: ['看', '听', '练'] },
      { category: '社会', color: 'bg-[#ffefec]', iconColor: 'text-error', icon: Users, topics: ['情绪管理', '合作', '诚实'], skills: ['听', '说', '练'] },
    ]
  };
          ...
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 rounded-full overflow-hidden border-4 border-primary-container">
              <img 
                ...
                src="https://lh3.googleusercontent.com/aida-public/AB6AXuCH84Uq0GW6Qmul4GmAsWrEgJqdNE5jjMcIbBe7kwfQ2hYAHKPmiFWbl3aNTwuFyiGlShFEi5MFOD1p0-oX98nOamNY7ksdaX71sx7TFqaAdXNQ38NvDGjE3Fkb-0oVPa-H513VLwzALu0Q1nm7nvM7epfqKThrc0fEvaiADvzEG7MpR2CqK8fUkFBEWXLoU1gIe68QgYeIqK_W2C2HmCcVRvtl7lBc_oRFXgONUbLf0QhmZreiC5aQ8Ow2zjaOwudcC6RVVyls1Kg"
        ...
        <section className="relative mb-12">
          <div className="bg-surface-container-lowest rounded-xl p-8 flex items-end gap-6 shadow-xl border-b-8 border-surface-container-high relative overflow-hidden">
            ...
            <div className="flex-grow space-y-2 relative z-10">
              <p className="text-on-surface-variant font-bold text-lg">早上好，明明！</p>
          ...
          <div className="bg-primary p-1 rounded-xl shadow-xl">
            <div className="bg-surface-container-lowest rounded-[2.5rem] overflow-hidden">
              <div className="h-48 relative">
                <img 
                  className="w-full h-full object-cover" 
                  src="https://lh3.googleusercontent.com/aida-public/AB6AXuCIdmL6u7oUYyGelx43ITfb4-YfM0Sdvwf_h7l3Rq9N230FUNbfD3lJ9pk4RekEIHhFhMpsFlLxuoNSbYm2sXAT4OcGyvaKw8XtlAXrBRkbu2ekvYiNZIBb9Waoa2xSpR4jv3Rr6Z7bMgio4wExvRDLzTeaHKj2p7s4MtsfoIw4emdVsgRAFCY5Za1mtiLU12vnJZZrJH2mH8-QVx2AbR8x1zgudJNoFuu678YkirEW4mTQHKfhipQXH8sU3aUugDCKD4MnvOcboG4"
                  referrerPolicy="no-referrer"
                />
                <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent"></div>
                <div className="absolute bottom-4 left-6">
                  <span className="text-white font-black text-2xl uppercase tracking-widest">Level 04</span>
                  <h4 className="text-white font-bold text-lg">太空单词工厂</h4>
                </div>
              </div>
