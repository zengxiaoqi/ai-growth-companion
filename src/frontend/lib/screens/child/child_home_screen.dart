...
import 'child_video_screen.dart';
  ...
  Widget _buildFunctionSection(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        GestureDetector(
          onTap: () {
            Navigator.pushNamed(context, '/book-skill/browse');
          },
          child: AppCard(
            padding: const EdgeInsets.all(20),
            gradient: const LinearGradient(
        ...
        GestureDetector(
          onTap: () {
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (_) => const ChildVideoScreen(),
              ),
            );
          },
          child: AppCard(
            ...
            boxShadow: AppTheme.softShadow(const Color(0xFFFF6B6B)),
            child: Row(
              children: [
                Container(
                  padding: const EdgeInsets.all(12),
